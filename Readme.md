...
2025/1/18 - 注册了一个新的steam账号，付了100刀的游戏槽位，正在等待税务审批（说是等2-7天）

2025/1/19 - 把新的开头界面画好了，做了简单的背景入场动画，并且树叶背景会随着鼠标移动做轻微偏移，加了BGM

2025/1/20 - 对应新的开头，加了设置，退出游戏，进入游戏三个按钮，把设置面板改为了二级菜单，搭好了选关界面的骨架
